...
public class FacebookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Meu perfil do facebook");
    ...
    private void logout(){
        ...
        Intent login = new Intent(FacebookActivity.this, Login.class);
        startActivity(login);
        finish();
    }
    ...
    private void sendImage(){
        ...
        if (picking){
            MessengerUtils.finishShareToMessenger(FacebookActivity.this, shareToMessengerParams);
        } else {
            MessengerUtils.shareToMessenger(FacebookActivity.this, REQUEST_CODE, shareToMessengerParams);
        }
    }
}
